    ...
    <section id="projects" className="py-20 bg-gradient-to-b from-background to-card/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <RippleText text="My Work" className="text-3xl md:text-4xl font-bold inline-block" />
          ...
          <div className="mt-6">
            <Button asChild variant="outline">
              <Link to="/vibe-coding" className="flex items-center gap-2">
                <span>View All Vibe Coding Projects</span>
            ...
            <Card key={index} className="project-card bg-card/50 backdrop-blur-sm border-border/50 overflow-hidden group">
              <div className="h-48 overflow-hidden bg-muted">
                <img 
                  src={project.image} 
                  alt={project.title} 
                  className="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity transform group-hover:scale-105 duration-300"
                />
              </div>
              <CardHeader>
