...
const Eye: React.FC<EyeProps> = ({ mouseX, mouseY, selfRef, otherRef }) => {
  ...
  return (
    <div
      ref={selfRef}
      className="relative bg-white border-2 border-black rounded-full h-8 w-8 flex items-center justify-center"
    >
      <div
        ref={pupilRef}
        className="absolute bg-black rounded-full h-3 w-3 transition-all duration-[5ms]"
      >
